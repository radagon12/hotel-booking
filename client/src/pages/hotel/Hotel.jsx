...
const Hotel = () => {
  ...
  const days = dates.length && dayDifference(dates[0].endDate, dates[0].startDate);
          ...
          <div className="hotelContainer">
            ...
            <div className="hotelWrapper">
              ...
              <span className="hotelPriceHighlight">
                Book a stay over ₹{data && data.cheapestPrice} at this property and get a free airport
                taxi
              </span>
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  ...
                  <h2>
                    <b>₹{data && days * data.cheapestPrice * options.room}</b> ({days} nights)
                  </h2>
